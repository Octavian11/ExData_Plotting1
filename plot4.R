...
# Set the Device up for 4 plots
par(mfrow = c(2,2))

# Draw the plots
with(dt2, plot(dt2$Global_active_power ~ dt2$dateTime, type = "l", xlab = "datetime", ylab = "Global_active_power"))
with(dt2, plot(dt2$Voltage ~ dt2$dateTime, type = "l", xlab = "datetime", ylab = "Voltage"))
...
with(dt2, plot(dt2$Global_reactive_power ~ dt2$dateTime, type = "l", xlab = "datetime", ylab = "Global_reactive_power"))
